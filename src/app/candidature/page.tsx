        ...
        <div className="min-h-screen bg-gradient-to-br from-[#00132c] via-[#003F92] to-[#00132c] relative overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 py-8 max-w-5xl">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-gradient-to-r from-[#4fc3f7]/20 to-[#f97316]/20 rounded-full border border-white/10 backdrop-blur-sm">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-sm text-[#4fc3f7]/70 font-medium">
                            Progression
                        </span>
                    ...
                    <div className="h-3 bg-white/5 rounded-full overflow-hidden border border-white/10">
                        <div
                            className="h-full bg-gradient-to-r from-[#4fc3f7] via-[#f97316] to-[#4fc3f7] transition-all duration-500 rounded-full relative"
                            ...
                            >
                                <div
                                    className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 transition-all duration-300 ${
                                        step > idx
                                            ? "bg-gradient-to-br from-[#4fc3f7] to-[#f97316] scale-110"
                                            : step === idx
                                            ? "bg-gradient-to-br from-[#4fc3f7] to-[#f97316] animate-pulse"
                        ...
                        {step === 0 && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#4fc3f7] to-[#f97316] flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-[#4fc3f7]/70">
                            ...
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <div
                                                            className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                                                isSelected
                                                                    ? "bg-gradient-to-br from-[#4fc3f7] to-[#f97316]"
                                                                    : "bg-white/10"
                                                            }`}
                                                        >
                                ...
                                <div className="space-y-4">
                                    <label className="block text-sm font-medium text-[#4fc3f7] mb-3 flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-[#4fc3f7]/50 font-normal">
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        {!file ? (
                                            ...
                                            >
                                                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#4fc3f7] to-[#f97316] flex items-center justify-center">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#4fc3f7] to-[#f97316] flex items-center justify-center">
                                                        <FileText className="w-6 h-6 text-white" />
                                                    </div>
                                                    <div>
                                                        <p className="text-[#4fc3f7] font-medium">
                                                            {file.name}
                                                        </p>
                                                        <p className="text-sm text-[#4fc3f7]/50">
                                                            {humanFileSize(
                            ...
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4 p-6 rounded-xl bg-white/5 border border-white/10">
                                        <div className="flex items-center gap-2 mb-4">
                                            ...
                                            <h3 className="font-semibold text-[#4fc3f7]">
                                        ...
                                        <div className="space-y-3 text-sm">
                                            ...
                                            {form.linkedIn && (
                                                <div>
                                                    ...
                                                    <p className="text-[#4fc3f7] font-medium truncate">
                                                        {form.linkedIn}
                                                    </p>
                                                </div>
                                            )}
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#4fc3f7] to-[#f97316] flex items-center justify-center">
                                ...
                                {form.experience && (
                                    <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                                        ...
                                        <p className="text-sm text-[#4fc3f7]/80 whitespace-pre-wrap">
                                            {form.experience}
                                        </p>
                                    </div>
                                )}
                                ...
                                <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                                    ...
                                    <p className="text-sm text-[#4fc3f7]/80 whitespace-pre-wrap leading-relaxed">
                                        {form.motivation}
                                    </p>
                                </div>
                                ...
                                {file && (
                                    <div className="p-6 rounded-xl bg-white/5 border border-white/10">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#4fc3f7] to-[#f97316] flex items-center justify-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-[#4fc3f7]/60">
                                                        {file.name} •{" "}
                                                        {humanFileSize(
                                                            file.size
                                                        )}
                                ...
                                <div className="p-4 rounded-xl bg-gradient-to-r from-[#4fc3f7]/10 to-[#f97316]/10 border border-[#4fc3f7]/20">
                    ...
                    <div className="px-6 md:px-8 pb-6 md:pb-8 flex items-center justify-between border-t border-white/10 pt-6">
                        ...
                        {step < 3 ? (
                            <button
                                type="button"
                                onClick={nextStep}
                                className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#4fc3f7] to-[#f97316] text-white font-semibold hover:shadow-lg hover:shadow-[#4fc3f7]/30 transition-all hover:scale-105 flex items-center gap-2"
                            >
                                Continuer
                            ...
                            <button
                                ...
                                className="px-8 py-3 rounded-xl bg-gradient-to-r from-[#4fc3f7] to-[#f97316] text-white font-bold hover:shadow-lg hover:shadow-[#4fc3f7]/30 transition-all hover:scale-105 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                            >
                                {isSubmitting ? (
                                    <>
                ...
                <div className="mt-8 text-center">
                    <p className="text-sm text-[#4fc3f7]/60">
                        ...
                        <a
                            ...
                            className="text-[#4fc3f7] hover:text-[#f97316] transition-colors underline"
                        >
